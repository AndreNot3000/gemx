const styles = {
  ...
  heroDText:
      'md:w-[212px] sm:w-[80px] w-[60px] md:h-[90px] sm:h-[48px] h-[38px] md:border-[18px] sm:border-[8px] border-[6px] border-white rounded-l-[50px] rounded-r-[50px] border-r-0 sm:mx-2 mx-[6px]',
};
